            ...
            <section className="relative w-full bg-white pt-12 sm:pt-16 pb-24 sm:pb-32 px-6 sm:px-12 md:px-16 lg:px-24 z-10 select-none">
                <div className="w-full">
                    ...
                    >
                        ...
                        <Link
                            to="/contacts"
                            className="px-8 py-4 sm:px-12 sm:py-5 bg-pink-500 text-white rounded-full font-black uppercase text-[10px] sm:text-xs md:text-sm tracking-[0.2em] sm:tracking-[0.3em] hover:bg-pink-600 transition-all duration-300 shadow-lg shadow-pink-500/20 hover:shadow-pink-500/40 relative z-10 inline-block"
                        >
