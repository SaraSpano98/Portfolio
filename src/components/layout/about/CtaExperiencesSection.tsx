        ...
        <section className="relative w-full bg-white text-slate-900 px-6 sm:px-12 md:px-16 lg:px-24 pt-12 pb-32 select-none overflow-hidden z-10">
            <div className="w-full">
                ...
                <motion.div 
                    ...
                    onMouseMove={handleMouseMove} // ATTIVATO: Tracciamento movimento mouse
                ...
                >
                    ...
                    {/* INSERITO: BAGLIORE ROSA DINAMICO AL PASSAGGIO DEL MOUSE */}
                    <div
                    ...
                    {/* PATTERN GEOMETRICO A GIGLIA EXTRA*/}
